...
export type CartItemsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "productId" | "quantity" | "createdAt" | "updatedAt", ExtArgs["result"]["cartItems"]>
...
export interface CartItemsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const cartItemsWithUserIdOnly = await prisma.cartItems.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CartItems and only return the `userId`
   * const cartItemsWithUserIdOnly = await prisma.cartItems.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more CartItems and only return the `userId`
   * const cartItemsWithUserIdOnly = await prisma.cartItems.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
